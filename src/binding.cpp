...
PYBIND11_MODULE(_zctc, m)
{
    py::class_<zctc::Decoder>(m, "_Decoder")
        .def(py::init<int, int, int, int, float, float, py::ssize_t, float, char, std::vector<std::string>, const char*,
                      const char*>(),
        ...
        .def("batch_decode", &zctc::Decoder::batch_decode<float>, py::arg("batch_log_logits"),
             ...
             py::arg("batch_size"), py::arg("max_seq_len"), py::arg("hotwords"), py::arg("hotwords_weight"),
