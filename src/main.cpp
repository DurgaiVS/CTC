...
int main(int argc, char** argv) {
    std::vector<float> logits = {0.2968, 0.0912, 0.7428, 0.5030, 0.1075, 0.8555, 0.6346, 0.7288,
    ...
    std::vector<int> sorted_indices = {5, 2, 7, 6, 3, 0, 4, 1,
        6, 7, 2, 5, 3, 0, 1, 4,
        6, 1, 0, 7, 4, 5, 3, 2,
        4, 1, 0, 3, 5, 6, 2, 7,
        3, 7, 4, 1, 0, 6, 5, 2,
    ...
    std::vector<int> labels(20 * 12, 0);
    std::vector<int> timesteps(20 * 12, 0);

    Decoder decoder(1, 0, 8, 8, 0.9, 20);
